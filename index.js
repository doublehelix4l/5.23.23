...
function declareTributes(obj){
    console.log((obj.name + " from District " + obj.district))
}
...
function removeFaultyToys(toyInventory){
    const newArr = [];
    if (toyInventory.containsChemicals === true){

    } else {newArr.push(toyInventory)}
    return newArr
}


console.log(toyInventory2023.map(removeFaultyToys))